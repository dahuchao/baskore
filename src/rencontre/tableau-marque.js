...
export default class Marque extends React.Component {
  // surPeriode(periode) {   this.props.surPeriode(periode) }
  render() {
    const style = {
      minWidth: "2em",
      height: "1.5em"
    ...
    const stylePeriode = {
      cursor: this.props.modeVerrouille
        ? "default"
        : "pointer",
      minWidth: "0",
      lineHeight: "1.3em",
    ...
    return (
      <div id="marque">
        <div id="periodes">{[1, 2, 3, 4].map(periode => {
            ...
            return (<FlatButton
              ...
              key={periode}
              onClick={this.props.modeVerrouille
              ? null
              : () => this
                .props
                .surPeriode(periode)}
